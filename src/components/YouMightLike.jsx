...
export default function YouMightLike() {
  const itemsData = [
    ...
    {
      imgItem:
        "/public/assets/img/coversMini/albums/flashback_from_2001-mini.jpg",
      titleItem: "Album Flashback From 2001",
      titleArtist: "El Double M",
      priceItem: "11.99",
    },
    {
      imgItem: "/public/assets/img/other-members/albums/rose-terrace.jpg",
    ...
    {
      imgItem:
        "/public/assets/img/other-members/albums/into-to-different-dimension.jpg",
      titleItem: "Album Into To Different Dimension",
      titleArtist: "Molly Granoli",
      priceItem: "8.99",
    },
    {
      imgItem: "/public/assets/img/other-members/albums/lone-rider-album.jpg",
      titleItem: "Album Lone Rider",
      titleArtist: "Jackie Ras",
      priceItem: "9.99",
    },
    {
      imgItem: "/public/assets/img/single-collection-albums/dream-chaser-2.jpg",
