    ...
    <form className="form-delivery-details" action="">
      <fieldset className="fieldset-form--delivery-details">
        ...
        <InputDeliveryFullName
          ...
          onChange={(value, isValid) => handleInputChange('fullName', value, isValid)}
        />
        ...
        <InputDeliveryCountrySelect
          ...
          onChange={(value, isValid) => handleInputChange('country', value, isValid)}
        />
        <div className="postal-code-wth-city">
          <InputDeliveryZipCode
            value={formData.zipCode.value}
            onChange={(value, isValid) => handleInputChange('zipCode', value, isValid)}
          />
          <InputDeliveryCity
            value={formData.city.value}
            onChange={(value, isValid) => handleInputChange('city', value, isValid)}
          />
        </div>
        <InputDeliveryAddress
          value={formData.address.value}
          onChange={(value, isValid) => handleInputChange('address', value, isValid)}
        />
        <ChooserDeliveryOptions
          value={formData.deliveryOption.value}
          onChange={(value, isValid) => handleInputChange('deliveryOption', value, isValid)}
        />
      </fieldset>
      <BadgeFormRequired />
